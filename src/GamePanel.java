...
public class GamePanel extends JPanel implements ActionListener{
	...
	public void move() {
		...
		for(int i = bodyParts; i > 0; i--) {
			...
			x[i] = x[i - 1]; //shift coordinates by one
		...
		case 'U':
			...
			y[0] = y[0] - UNIT_SIZE; //y-coordinate at head of snake goes to next position
	...
	public void checkApple() {
		...
		//if head = x-position of apple and head = y-position of apple
	...
	public void checkCollisions() {
		...
		for(int i = bodyParts; i > 0; i--) {
			...
			if((x[0] == x[i]) && (y[0] == y[i])) { //if head hits another bodypart
